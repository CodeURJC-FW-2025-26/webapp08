...
### Requisitos
- Node.js >= 18 (recomendado: 18 - 24)
- MongoDB (local o Atlas). Ej.: MongoDB 5.x / 6.x funciona correctamente.
...
### Resumen
Aplicación web (Node + Express + MongoDB + Mustache + Ajax) que gestiona un catálogo de platos (Plate) y sus ingredientes (Ingredient). Implementa creación, edición, borrado, paginación, filtros, subida de imágenes (multer), páginas intermedias de confirmación y páginas de error reutilizando partials (header/footer).
